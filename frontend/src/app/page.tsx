  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <a
          href="/fellowship"
          className="flex items-center gap-3 p-4 rounded-xl bg-violet-50 border border-violet-100 text-violet-800 hover:bg-violet-100 transition-colors"
        >
          <div className="w-10 h-10 rounded-full bg-violet-200 flex items-center justify-center text-violet-700">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
